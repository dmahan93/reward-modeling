...
def convert_deepspeed_checkpoint(is_rm=True):
    ...
    model_path = "/mnt/nvme/home/dakota/ckpts/gptj-sca"
    model_ckpt = "checkpoint-1140/"
    type_t = "causal"
    if is_rm:
...
def hf_upload(make_repo=True):
    ...
    converted_ckpt = "/mnt/nvme/home/dakota/ckpts/gptj-sca/hf_ckpt"
    repo_name = "dmayhem93/self-critique-answer-gpt-j-rm"
    if make_repo:
